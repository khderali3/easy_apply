...
from ..views_package.site_views import (RequestServiceView, RequestAgentView, CheckRequestStatusView, GetPricesInfoView, GetAppIndexView, SpeedPackagePriceList)
...
urlpatterns = [
    ...
    path("speed_package_list/", SpeedPackagePriceList.as_view())
]
