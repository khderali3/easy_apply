...
urlpatterns = [
    ...
    path('users/<int:id>/permission/', UserPermissionView.as_view(), name='assign-remove-permission'),
    path('users/<int:id>/group/', UserGroupView.as_view(), name='assign-remove-group'),
